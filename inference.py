...
parser.add_argument('--sr_path', type=str,
                    help='Name of saved checkpoint of super-resolution network', default='checkpoints/net_g_67500.pth')

parser.add_argument('--face', type=str,
                    help='input_videos/mona.mp4')
parser.add_argument('--audio', type=str,
                    help='input_audios/ai.wav')
parser.add_argument('--outfile', type=str, help='Video path to save result. See default for an e.g.',
                    default='results/result_voice1.mp4')
...
args.img_size = 96
# args.face = 'input_videos/mona.mp4'
# args.audio = 'input_audios/temp.wav'
# args.checkpoint_path = 'checkpoints/wav2lip_gan.pth'
# args.segmentation_path = 'checkpoints/face_segmentation.pth'
# args.sr_path = 'checkpoints/RealESRGAN_x4plus.pth'
# args.sr_path = 'experiments/001_ESRGAN_x4_f64b23_custom16k_500k_B16G1_wandb/models/net_g_67500.pth'
# args.sr_path = 'checkpoints/esrgan_yunying.pth'
# args.sr_path = 'checkpoints/visual_quality_disc.pth'
# args.outfile = 'results/result_voice1.mp4'
# args.static = False
...
print('Using {} for inference.'.format(torch.device(device)))
